 ...
 */
public class FollowersAsyncTask extends AsyncTask<String, Integer, ArrayList<GithubUser>> {


    public static final String TAG = FollowersAsyncTask.class.getSimpleName();
    ...
    public FollowersAsyncTask(GithubListener listener) {
        mListener = listener;
    }
